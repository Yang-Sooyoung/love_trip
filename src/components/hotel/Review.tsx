...
function Review({ hotelId }: { hotelId: string }) {
  ...
  const reviewRows = useCallback(() => {
    if (reviews?.length === 0) {
      return (
        <Flex direction="column" align="center" style={{ margin: '0' }}>
          <img
            src="https://cdn4.iconfinder.com/data/icons/business-and-finance-colorful-free-hand-drawn-set/100/message_open-128.png"
            alt=""
          />
          <Spacing size={10} />
          <Text typography="t6">
